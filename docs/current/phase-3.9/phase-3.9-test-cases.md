# Phase 3.9 — Manual Test Cases (Telegram)
...
Trước khi test, cần có tài khoản Telegram với data đã setup:
...
## TC-T035: 3 personas đều briefing được
**Steps:**
...
> Khi test xong toàn bộ: đổi dòng `<!-- testing-signoff: need to be signed -->` thành `<!-- testing-signoff: signed -->` để trigger auto-archive.
