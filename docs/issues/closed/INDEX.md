...
| #26 | Phase 1 | [Phase 1 - Week 1] Setup Categories & Emoji Config System | [phase-1/issue-26.md](by-phase/phase-1/issue-26.md) |
| #27 | Phase 1 | [Phase 1 - Week 1] Rich Message Formatter — Progress Bar, Money Format & Templates | [phase-1/issue-27.md](by-phase/phase-1/issue-27.md) |
| #28 | Phase 1 | [Phase 1 - Week 2] Inline Keyboard System for Transactions | [phase-1/issue-28.md](by-phase/phase-1/issue-28.md) |
| #29 | Phase 1 | [Phase 1 - Week 3] Telegram Mini App — Dashboard v1 | [phase-1/issue-29.md](by-phase/phase-1/issue-29.md) |
| #30 | Phase 1 | [Phase 1 - Week 4] Visual Identity — Bot Name, Mascot & Tone Writing | [phase-1/issue-30.md](by-phase/phase-1/issue-30.md) |
| #31 | Phase 1 | [Phase 1] Setup Analytics Event Tracking | [phase-1/issue-31.md](by-phase/phase-1/issue-31.md) |
| #32 | Phase 1 | [Phase 1] Exit Criteria Checklist — Gate before Phase 2 | [phase-1/issue-32.md](by-phase/phase-1/issue-32.md) |
| #37 | Phase 2 | [Phase 2 - Week 1] Database Schema — Onboarding, Milestones, Events, Streaks | [phase-2/issue-37.md](by-phase/phase-2/issue-37.md) |
| #38 | Phase 2 | [Phase 2 - Week 1] Onboarding Flow — 5-Step State Machine | [phase-2/issue-38.md](by-phase/phase-2/issue-38.md) |
| #39 | Phase 2 | [Phase 2 - Week 2] Milestone Detection & Celebration Messages | [phase-2/issue-39.md](by-phase/phase-2/issue-39.md) |
| #40 | Phase 2 | [Phase 2 - Week 2] Empathy Engine — Contextual Emotional Responses | [phase-2/issue-40.md](by-phase/phase-2/issue-40.md) |
| #41 | Phase 2 | [Phase 2 - Week 3] Streak System — Daily Habit Tracking | [phase-2/issue-41.md](by-phase/phase-2/issue-41.md) |
| #42 | Phase 2 | [Phase 2 - Week 3] Weekly Fun Facts Generator | [phase-2/issue-42.md](by-phase/phase-2/issue-42.md) |
...
| #128 | Pre-Phase | [Story] P3.5-S15: Add follow-up suggestions as inline buttons | [pre-phase/issue-128.md](by-phase/pre-phase/issue-128.md) |
...
| #167 | Pre-Phase | [Story] P3.6-S7: Add wealth-level detection to MenuFormatter | [pre-phase/issue-167.md](by-phase/pre-phase/issue-167.md) |
...
| #242 | Pre-Phase | [Epic] Phase 3.8.5 — Epic 2: User Profile (View) | [pre-phase/issue-242.md](by-phase/pre-phase/issue-242.md) |
| #243 | Pre-Phase | [Epic] Phase 3.8.5 — Epic 3: User Profile (Edit) | [pre-phase/issue-243.md](by-phase/pre-phase/issue-243.md) |
...
| #248 | Pre-Phase | [Story] P3.8.5-S5: ProfileStatsAggregator — auto-derived stats | [pre-phase/issue-248.md](by-phase/pre-phase/issue-248.md) |
...
| #278 | Pre-Phase | [Story] P3.9-S11: PNJ gold scraper (backup) | [pre-phase/issue-278.md](by-phase/pre-phase/issue-278.md) |
...
| #283 | Pre-Phase | [Story] P3.9-S16: Morning briefing enrichment (real data) | [pre-phase/issue-283.md](by-phase/pre-phase/issue-283.md) |
...
| #345 | Pre-Phase | [Story] P3.9.5-S7: Dedupe — bỏ "So sánh tháng trước" trùng | [pre-phase/issue-345.md](by-phase/pre-phase/issue-345.md) |
...
| #374 | Pre-Phase | [Epic] Phase 4A — Epic 6: Channel-Agnostic Foundation & Polish | [pre-phase/issue-374.md](by-phase/pre-phase/issue-374.md) |
...
| #472 | Pre-Phase | [Story] P4.1-A7: Feedback triage UI | [pre-phase/issue-472.md](by-phase/pre-phase/issue-472.md) |
...
| #481 | Pre-Phase | [Story] P4.1-A1: Onboarding redesign — 3-step guided flow | [pre-phase/issue-481.md](by-phase/pre-phase/issue-481.md) |
...
| #495 | Pre-Phase | [Epic] Phase 4.1 — EPIC 3: Soft Launch Playbook & Founding Cohort | [pre-phase/issue-495.md](by-phase/pre-phase/issue-495.md) |
...
| #506 | Pre-Phase | [Story] P4.1-C1: Acquisition source + invite tracking + source-aware copy | [pre-phase/issue-506.md](by-phase/pre-phase/issue-506.md) |
| #507 | Pre-Phase | [Story] P4.1-C2: Success metrics rubric | [pre-phase/issue-507.md](by-phase/pre-phase/issue-507.md) |
| #508 | Pre-Phase | [Story] P4.1-C3: Kill criteria documentation | [pre-phase/issue-508.md](by-phase/pre-phase/issue-508.md) |
...
| #541 | Pre-Phase | [Epic] Phase 4.2 — Epic 3: Positioning Validation | [pre-phase/issue-541.md](by-phase/pre-phase/issue-541.md) |
...
| #547 | Pre-Phase | [Story] P4.2-3.1: Day 7 Positioning Micro-Survey | [pre-phase/issue-547.md](by-phase/pre-phase/issue-547.md) |
...
| #575 | Pre-Phase | [Epic] Phase 4.2.5 — Epic 3: User Management APIs | [pre-phase/issue-575.md](by-phase/pre-phase/issue-575.md) |
...
| #584 | Pre-Phase | [Story] P4.2.5-2.1: Overview stats endpoint | [pre-phase/issue-584.md](by-phase/pre-phase/issue-584.md) |
...
| #1027 | Pre-Phase | [Bug] stock_updater: snapshot fallback ghi đè baseline live → cảnh báo "biến động 15 phút" sai | [pre-phase/issue-1027.md](by-phase/pre-phase/issue-1027.md) |
| #1028 | Phase 5 | [Phase 5.0 — chặn gate] Lời mời Telegram từ Zalo không mang danh tính → tạo user thứ hai, tách đôi dữ liệu tài chính | [phase-5/issue-1028.md](by-phase/phase-5/issue-1028.md) |
...
**Total:** 512 closed issues
(7 Phase 1, 9 Phase 2, 1 Phase 3A, 28 Phase 4, 2 Phase 5, 465 Pre-Phase)
