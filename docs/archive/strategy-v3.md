...
> **⚠️ ARCHIVED (07/2026):** Document này đã được superseded bởi [strategy.md](../current/strategy.md) (V4 — Decision Engine pivot sau soft launch tháng 6/2026). Lý do pivot tại [MIGRATION_NOTES_V3_TO_V4.md](./MIGRATION_NOTES_V3_TO_V4.md). Không update nữa.
