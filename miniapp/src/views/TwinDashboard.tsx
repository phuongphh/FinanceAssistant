  ...
  return (
    <main class="shell">
      <header class="hero">
        ...
        <p>{payload.delta_vs_p50 ? `${money(payload.delta_vs_p50)} vs P50` : 'Đang theo dõi P50'}</p>
      </header>
      ...
      <section class="card">
        <h2>Mốc 10 năm</h2>
        <div class="kpis">
          <Kpi label="P10" value={target?.p10} />
          <Kpi label="P50" value={target?.p50} />
          <Kpi label="P90" value={target?.p90} />
        </div>
      </section>
      <section class="card">
        <h2>Phân bổ</h2>
